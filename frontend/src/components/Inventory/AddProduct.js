    ...
    <dialog open id="addItemDialog">
      ...
      <table >
          ...
          <td className="label-cell">Item Name:</td>
            <td><input type="text" id="item-name" autocomplete="one-time-code" placeholder="Item Name" value={itemData.itemName} name="itemName" onChange={(e) =>
                              handleInputChange(e.target.name, e.target.value)
                            }/></td>
         <td className="label-cell">Item ID:</td>
            <td><input type="text" id="item-id" autocomplete="one-time-code" placeholder="Item ID" value={itemData.itemID} name="itemID" onChange={(e) =>
                              handleInputChange(e.target.name, e.target.value)
                            }/></td>
          </tr>
          <tr>
