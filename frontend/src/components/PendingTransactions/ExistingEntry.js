...
const ExistingEntry = ({ isVisible, entryType, handleExistingEntryDialog, handlePageUpdate, amount, existingEntryName, existingEntryId }) => {
...
const updateCustAmount = () => {
  ...
  return (
    ...
    >
      <p>There already exists a {entryType} with name '{existingEntryName}' associated with this email. 
      Do you want to add this amount to {existingEntryName}'s log?</p> 
        ...
        >
          <button
            type="button"
            onClick={() => {handleExistingEntryDialog();updateExisting();}}
            style={{
              width: "45%",
