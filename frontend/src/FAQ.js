  ...
  return (<>
    ...
    >
      {/* // Change Password Section */}
            ...
            <p>
                <strong>A. Click on the settings icon in the top right corner. Then select the "Change Password" option from the dropdown menu. An OTP will be sent to your registered Email ID. Enter this OTP and create a new password.</strong>
            </p>
            </div>
            ...
            <p>
                <strong>A.Click on the Profile icon in the top right corner to open your profile page. Click on the ‘Edit Profile’ button, make all the changes, then click ‘Save Profile’ button to save the changes.</strong>
            </p>
            </div>
            ...
            <p>
                <strong>A.Click on the settings icon in the top right corner. Then click on the ON/OFF toggle button in front of the Notifications option in the dropdown menu.</strong>
            </p>
            </div>
            ...
            <p>
                <strong>A.‘Preview Bill’ button can be used to preview a draft of the Invoice before printing.</strong>
            </p>
            </div>
            ...
            <p>
                <strong>A.You can report your issues via email provided on our ‘Contact Us’ page.</strong>
            </p>
            </div>
